 ...
 *
 */
namespace Piwik\Plugins\OpeniLocationTracker\Reports;
 ...
 */
class TrackByLocation extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('OpeniLocationTracker_TrackByLocation');
        $this->dimension     = null;
        ...
        $this->menuTitle    = 'Track By Location';
        ...
        $this->widgetTitle  = 'Track By Location';
    }
...
//        $settings = new \Piwik\Plugins\OpeniLocationTracker\Settings('OpeniLocationTracker');
//        $columnToAggregate = $settings->realtimeReportDimension->getValue();
//        $columnLabel = \Piwik\Plugins\OpeniLocationTracker\OpeniLocationTracker::$availableDimensionsForAggregation[$columnToAggregate];


        $view->config->addTranslation('label', 'Location');
    ...
    {
        $view = new View('@OpeniLocationTracker/trackByLocation');
        $view->myData = array();
